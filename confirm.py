...
for n in k:
    ...
    # fig, ax = ox.plot_graph(G, node_size = 0.5)
    ...
    # fig, ax = ox.plot_graph_route(G, route, route_color = 'r', route_linewidth = 6, node_size = 0.5)

    # folium으로 html 파일 생성
    location = (33.45470924, 126.5650887)
    location2 = (P[n][2], P[n][3])
    extra_lenth = 0

    try:
        route_graph_map = ox.plot_route_folium(G, route, tiles = "OpenStreetMap")
        folium.Marker(location).add_to(route_graph_map)
        folium.Marker(location2).add_to(route_graph_map)
        ...
        route_graph_map.save(f'routh_with_folium{n}.html')
    except ValueError:
        ...
        if n == 5: 
            ...
            folium.PolyLine(extra_location).add_to(route_graph_map)
            extra_lenth = 0.118
            route_graph_map.save('routh_with_folium5.html')
        elif n == 10:
            extra_location=[[33.45497, 126.56512], [33.45530, 126.56512], [33.45533, 126.56597]]
            folium.PolyLine(extra_location).add_to(route_graph_map)
            extra_lenth = 0.134
            route_graph_map.save('routh_with_folium10.html')
        elif n == 38:
            extra_location=[[33.45453, 126.56523], [33.45439, 126.56524], [33.45440, 126.56648], [33.45465, 126.56691], [33.45416, 126.56718]]
            folium.PolyLine(extra_location).add_to(route_graph_map)
            extra_lenth = 0.245
            route_graph_map.save('routh_with_folium38.html')
        elif n == 65:
            extra_location=[[33.45474, 126.56428], [33.45472,126.56350]]
            folium.PolyLine(extra_location).add_to(route_graph_map)
            extra_lenth = 0.075
            route_graph_map.save('routh_with_folium65.html')
        else:
            print("현재 위치입니다.")
